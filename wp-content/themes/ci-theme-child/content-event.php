...
<article <?php post_class('fl-post'); ?> id="fl-post-<?php the_ID(); ?>" <?php FLTheme::print_schema(' itemscope itemtype="https://schema.org/BlogPosting"'); ?>>
    ...
    <div class="fl-post__duration">
        ...
        <?php
        $postDuration = get_field('estimated');
    ...
    <div class="fl-post__description">
                ...
                while (have_rows('speakers')) : the_row();
                    ...
                    <?php } else { ?>
                        <div class="speaker is-custom-speaker">
                            ...
                            <?php the_sub_field('speaker_title'); ?>
                        </div>
                    <?php }  ?>
        ...
        <div class="fl-post__categories">
            <?php
            $terms = wp_get_post_terms(get_the_ID(), array('event_categories'));
            ...
            <?php $getslugid = wp_get_post_terms($post->ID, 'event_category');
            foreach ($getslugid as $thisslug) { ?>

                <span><?php echo $thisslug->name; ?></span>
            <?php } ?>
        </div>
