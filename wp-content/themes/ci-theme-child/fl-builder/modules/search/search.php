...
class FLSearchModule extends FLBuilderModule {
	...
	public function render_button() {
		if ( 'input' != $this->settings->layout && 'modal_window' != $this->settings->layout ) {
				...
				'fields' => array(
					'layout'          => array(
						...
						'options' => array(
							...
							'modal_window' => __( 'Modal Window', 'fl-builder' ),
						...
						'toggle'  => array(
							...
							'modal_window' => array(
								'fields'   => array( 'search_btn_icon', 'search_input_icon'),
							),
						),
					),
					'search_btn_icon'     => array(
						'type'        => 'photo',
						'show_remove' => true,
						'label'       => __( 'Search button icon', 'fl-builder' ),
					),
					'search_input_icon'     => array(
						'type'        => 'photo',
						'show_remove' => true,
						'label'       => __( 'Search input button icon', 'fl-builder' ),
					),
					'placeholder'     => array(
						'type'    => 'text',
