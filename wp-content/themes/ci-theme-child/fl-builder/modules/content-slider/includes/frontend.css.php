...
.fl-content-slider .fl-slide-content-wrap .fl-slide-text p {
	font-size: 16px !important;
	line-height: 1.4 !important;
}
.fl-content-slider .fl-slide .fl-slide-photo-wrap .fl-slide-photo {
	margin-left: 51px;
}
.fl-content-slider .fl-slide-photo-wrap .fl-slide-photo img {
	width: 100% !important;
	object-fit: cover;
}
...
.fl-content-slider .bx-controls.bx-has-pager .bx-pager {
	bottom: -60px;
}

.fl-content-slider .bx-controls.bx-has-pager .bx-pager-item a {
	width: 25px;
	height: 25px;
	border-radius: 50%;
...
.fl-content-slider .bx-controls.bx-has-pager .bx-pager-item a.active {
	background-color: rgba(0,0,0,0.5);
}
@media screen and (max-width: 992px) { 
	.fl-content-slider .fl-content-slider-wrapper .fl-slide-photo-wrap {
		display: block;
	}
	.fl-content-slider .fl-content-slider-wrapper .fl-slide-mobile-photo {
		display: none
	}
	...
	.fl-content-slider .fl-content-slider-wrapper .fl-slide-foreground {
		display: flex;
		flex-direction: column-reverse;
		align-items: center;
	}
	.fl-content-slider .fl-content-slider-wrapper .fl-slide-foreground .fl-slide-content {
		margin-left: 0 !important;
		margin-right: 0 !important;
		text-align: center;
	}
	.fl-content-slider .fl-content-slider-wrapper .fl-slide-foreground .fl-slide-photo {
		margin-left: 0 !important;
		margin-right: 0 !important;
	}
}
...
@media screen and (min-width: 768px) { 
	...
	.fl-content-slider .fl-content-slider-svg-container, .fl-content-slider-navigation svg  {
...
for ( $i = 0; $i < count( $settings->slides ); $i++ ) {
	...
	// Vertical Alignment
	if ( $slide->vertical_alignment == 'start' ) {
		echo '.fl-node-' . $id . ' .fl-slide-' . $i;
		echo '{ display: flex; align-items: start; }';
	} elseif ( $slide->vertical_alignment == 'center' ) {
		echo '.fl-node-' . $id . ' .fl-slide-' . $i;
		echo '{ display: flex; align-items: center; }';
	} elseif ( $slide->vertical_alignment == 'end' ) {
		echo '.fl-node-' . $id . ' .fl-slide-' . $i;
		echo '{ display: flex; align-items: end; }';
	}
